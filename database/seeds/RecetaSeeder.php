...
class RecetaSeeder extends Seeder
{
  ...
  {
    Receta::create([
      'img_src' => 'img/crema_menta_chocolate.jpg',
    ...
    Receta::create([
      'img_src' => 'img/focaccia_mediterranea.jpg',
    ...
    Receta::create([
      'img_src' => 'img/pechuga_de_pollo.jpg',
    ...
    Receta::create([
      'img_src' => 'img/sopa_crema_de_arvejas.jpg',
    ...
    Receta::create([
      'img_src' => 'img/bife_de_chorizo.jpg',
    ...
    Receta::create([
      'img_src' => 'img/canelones_atun.jpg',
